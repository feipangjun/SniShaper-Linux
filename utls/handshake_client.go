...
func (c *Conn) clientHandshake(ctx context.Context) (err error) {
	...
	if ech != nil {
		...
		// name.
		// [uTLS MODIFIED] Check if outerServerName is set, if so use it instead of public_name
		if c.uconn != nil && c.uconn.outerServerName != "" {
			hello.serverName = c.uconn.outerServerName
		} else {
