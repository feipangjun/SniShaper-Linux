...
func newCoreRuntime() (*coreRuntime, error) {
	...
	return newCoreRuntimeForDir(execDir)
}

func newCoreRuntimeForDir(execDir string) (*coreRuntime, error) {
...
func (r *coreRuntime) startProxy() error {
	...
	availablePort, err := proxy.EnsurePortAvailable(originalPort, []string{"snishaper"})
	if err != nil {
